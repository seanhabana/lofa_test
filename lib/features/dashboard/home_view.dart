            ...
            _buildSection(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildEnrolledCourseCard(state.enrolledCourses[index]);
                  },
                ),
              ),
            ),
            ...
            _buildSection(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildRecommendedCourseCard(state.recommendedCourses[index]);
                  },
                ),
              ),
            ),
  ...
  Widget _buildFeaturedCourseCard(BuildContext context, Course course) {
    ...
    onTap: () {
      ...
      child: Column(
        ...
        children: [
          // Image with gradient overlay and title/rating
          Stack(
            children: [
              Container(
                height: 200,
